...
saveDesign top_specialRoute.enc
...
# SET TIMING FOR CLK
create_clock -name clk  -period 1300 -waveform {0 650} [get_ports clk]

source pins.tcl
saveDesign top.pin.enc
...
# Run CCopt
ccopt_design -outDir ./
saveDesign top.ccopt_design.enc

# Report timing
timeDesign -postCTS -expandedViews -outDir ./timing/
saveDesign top.timeDesign.enc
...
saveDesign top.routeDesign.enc

getFillerMode -quiet
addFiller -cell {TAPCELL_ASAP7_75t_R FILLERxp5_ASAP7_75t_R FILLER_ASAP7_75t_R} -prefix FILLER
ecoRoute -target
saveDesign top.ecoRoute.enc

# verifyGeometry  -error 1000000 -warning 50
# addFiller -fixDrc -cell {TAPCELL_ASAP7_75t_R FILLERxp5_ASAP7_75t_R FILLER_ASAP7_75t_R} -prefix FILLER
...
saveDesign top.postRoute.enc

#verifyConnectivity -type all -noAntenna -error 1000000 -warning 50
verify_drc

# saveDesign top.last.enc
verifyGeometry  -error 10000 -warning 50
#-eolMinOverlap 0.192
verifyConnectivity -type all -noAntenna -error 1000000 -warning 50
...
saveNetlist top.apr.v -excludeLeafCell -excludeCellInst {FILLERxp5_ASAP7_75t_R FILLER_ASAP7_75t_R}
saveNetlist top.apr_pg.v -includePowerGround -excludeLeafCell -excludeCellInst {FILLERxp5_ASAP7_75t_R FILLER_ASAP7_75t_R}


streamOut top.gds -mapFile /afs/asu.edu/class/e/e/e/eee525b/asap7/asap7PDK/cdslib/asap7_TechLib/asap7_fromAPR.layermap -libName top -units 4000 -mode ALL
