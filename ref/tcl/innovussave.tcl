...
floorPlan -site coreSite -r 1 0.90 5 5 5 5
...
# SET TIMING FOR CLK
create_clock -name clk  -period 330 -waveform {0 165} [get_ports clk]
report_clocks
...
setNanoRouteMode -drouteMinimizeLithoEffectOnLayer {f t t t t t t t t t} -routeTopRoutingLayer 5 -routeBottomRoutingLayer 2 -routeWithViaInPin true 
...
addFiller -cell {FILLERxp5_ASAP7_75t_R FILLER_ASAP7_75t_R} -prefix FILLER_
ecoRoute -target 
# ecoRoute -fix_drc
...
timeDesign -postRoute -expandedViews -outDir ./timing/
summaryReport
reportGateCount
