...
# dc_shell -f example.dc.tcl -output_log_file syn.log 
# vsim -c -do "vlog conv_pool.281.syn.v asap7sc7p5t_24_AO_RVT_TT.v      asap7sc7p5t_24_INVBUF_RVT_TT.v  asap7sc7p5t_24_OA_RVT_TT.v      asap7sc7p5t_24_R_4x_170912.lef  asap7sc7p5t_24_SEQ_RVT_TT.v     asap7sc7p5t_24_SIMPLE_RVT_TT.v tb_conv_pool.sv;  vsim tb; run -all; exit" > tb_conv_pool.syn.log

# Multicore Usage
set_host_options -max_cores 11
...
set netlist_search_path "/afs/asu.edu/users/n/b/e/nbeste/asap7_rundir/Lab5/"
# NETLIST NAME
set netlist_name "conv_pool.sv"
# CLOCK PERIOD
set clk_period 			281
# ################################################################################################
...
analyze -format sverilog $netlist_search_path/conv_pool_chan.sv
#analyze -format sverilog $netlist_search_path/count.sv
...
# Set Driving Cell might have na issue
...
report_timing -path full -delay max -max_paths $maxpaths -nworst 5 >> ${rpt_file}_setup_timing.rpt
report_timing -path full -delay min -max_paths $maxpaths -nworst 5 >> ${rpt_file}_hold_timing.rpt
