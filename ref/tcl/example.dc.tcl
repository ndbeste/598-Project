...
report_timing -path full -delay max -max_paths 5 -nworst 5 >> ${rpt_file}_setup_timing.rpt
report_timing -path full -delay min -max_paths 5 -nworst 5 >> ${rpt_file}_hold_timing.rpt
